This project uses machine learning models to classify the lung cancer subtypes: KIRC, KICH, and KIRP
...
In summary, pre-filtering techniques such as lasso regression and elastic net were used to filter the genes in the dataset to ones that are important for classifying lung cancer subtypes
